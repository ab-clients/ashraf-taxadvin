import { ServicesData } from "@/types/internal/services/services";
import {
  HiDocumentText,
  HiBookOpen,
  HiCreditCard,
...
const allServicesData: ServicesData = {
  individualTrack: [
    ...
    },
    {
      ...
      icon: HiCollection,
      description:
        "Protect your legacy with thorough planning that minimizes tax impact, preserves wealth across generations, and offers clear, compassionate guidance to families and executors throughout the entire process.",
      sections: [
        {
    ...
    },
    {
      ...
      icon: HiCalculator,
      description:
        "Stress-free accounting, tax planning, and compliance for freelancers, gig workers, and self-employed individuals. Maximize deductions, manage quarterly taxes.",
      sections: [
        {
  ...
  businessTrack: [
    {
      ...
      title: "Fractional CFO & Strategic Financial Leadership",
      icon: HiChartPie,
      description:
    ...
    {
      slug: "business-transformation-profit-growth",
      title: "Business Transformation: From Loss to Profit",
      icon: HiChartBar,
      description:
        "Transform struggling operations into a profitable, high-value business with tax strategies that highlight strong net income, minimize liability, and build equity for a future sale or capital raise.",
      sections: [
        {
          heading: "From Loss to Profit Roadmap",
          body: "We analyze your revenue model, cost structure, and operational bottlenecks to create a clear turnaround plan—converting negative cash flow into predictable profit.",
        },
        {
          heading: "Net Profit Reporting with Tax Efficiency",
          body: "Our tax planning ensures your financials reflect healthy net profits to investors and buyers while legally minimizing tax liability through timing, credits, and entity strategies.",
        },
        {
          heading: "Valuation & Exit Readiness",
          body: "Clean, profitable financials command higher multiples. We structure reporting and controls that increase your market value for future sale, merger, or financing.",
        },
        {
          heading: "Systems & KPI Discipline",
          body: "Implementation of dashboards, cost controls, and performance metrics so you track what drives profit and act quickly when trends shift.",
        },
        {
          heading: "Growth Capital & Stakeholder Confidence",
          body: "Stronger margins and tax-optimized profits attract investors, lenders, and strategic partners—fueling sustainable expansion and long-term wealth creation.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: HiHeart,
      description:
        "Grant tracking, fund accounting, and clear reporting—so you maintain donor trust, satisfy regulators, and focus on mission while strengthening financial transparency and stability.",
      sections: [
        {
...
export const individualServices = allServicesData.individualTrack;
export const businessServices = allServicesData.businessTrack;
export const allServices = individualServices.concat(businessServices);

const homepageServicesSlugs = [
  "virtual-cfo-financial-leadership",
  "business-transformation-profit-growth",
...
export const homepageServices = homepageServicesSlugs
  .map((slug) => {
    const service = allServices.find((s) => s.slug === slug);
    if (!service)
      throw new Error(
        `Service with slug "${slug}" not found in allServicesData.`
      );
    return service;
  })
  .slice(0, 6);
